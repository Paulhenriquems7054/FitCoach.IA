-- ============================================================================
-- Verificar se o Trigger e Função Estão Configurados Corretamente
-- ============================================================================
...
-- 3. Verificar as políticas RLS da tabela users
SELECT 
    schemaname,
    tablename,
    policyname,
...
-- 5. Listar usuários que têm auth mas não têm perfil
SELECT 
    au.id,
    au.email,
